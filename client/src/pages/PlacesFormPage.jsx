  ...
  async function savePlace(ev) {
    ...
    try {
      ...
      if (id) {
        ...
        //new place
        await axios.post("/api/places", placeData, { withCredentials: true });
        setRedirect(true);
    ...
    <div>
      ...
      <form onSubmit={savePlace}>
        ...
        {preInput(
          ...
          "add check in & check out time, remember to have some time window for cleaning room between guests."
        )}
        ...
        <button className="primary ">{loading ? <Loader size="30px" color="#fff" /> : 'Save'}</button>
      </form>
    </div>
  );
}
